    ...
    public void FillDatabase()
    {
        ...
        */
        ...
        ItemEntity itemElectronics1 = new ItemElectronicsEntity()
        {
            ...
            CpuModel = "Amd", MemoryCapacity = 256
        };
        ...
        ItemEntity itemElectronics2 = new ItemElectronicsEntity()
        {
            ...
            CpuModel = "Intel", MemoryCapacity = 256
        };
        ...
        ItemEntity itemElectronics4 = new ItemElectronicsEntity()
        {
            ...
            CpuModel = "Qualcomm", MemoryCapacity = 128
        };
        ...
        ItemEntity itemElectronics5 = new ItemElectronicsEntity()
        {
            ...
            CpuModel = "MediaTech", MemoryCapacity = 128
        };
        ...
        ItemEntity itemSport1 = new ItemSportEntity()
        {
            ...
            Description =
                "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.",
            Category = categorySport, Activity = "Heavy Lifting", Price = 100, Quantity = 10,
        ...
        ItemEntity itemSport2 = new ItemSportEntity()
        {
            ...
            Description =
                "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.",
            Category = categorySport, Activity = "Table tennis", Price = 150,
        ...
        ItemEntity itemSport3 = new ItemSportEntity()
        {
            ...
            Description =
                "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.",
            Category = categorySport, Activity = "Soccer", Price = 200,
